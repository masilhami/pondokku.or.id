...
export default function Header() {
  ...
  return (
    <header className="w-full bg-white select-none relative">
      ...
      {/* BARIS 1: HEADER UTAMA (STICKY PADA AWAL SCROLL) */}
      <div className="w-full border-b border-gray-100 bg-white sticky top-0 z-40 shadow-xs py-1">
        <div className="flex flex-col md:flex-row md:items-center justify-between px-4 py-2 max-w-[1200px] mx-auto gap-3 md:gap-4">
          ...
          {/* AREA SOSIAL MEDIA (TOMBOL LIVE DOKUMENTASI TELAH DIHAPUS) */}
      ...
      {/* BARIS 3: NAVIGASI KATEGORI UTAMA (STICKY SAMPAI SCROLL TERAKHIR) */}
